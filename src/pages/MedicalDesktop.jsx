...
import profilecard2 from '../assets/backgroundtheme.svg';

const MedicalDesktop = () => {
    return (
        
            <div className='bg-[#E5EFF3] h-screen w-screen'>
                <div className="p-10">
                ...
                <div className='flex items-center justify-center gap-[32px]'>
                    <div className='flex gap-[32px]'>
                        <div className='flex flex-col gap-9'>
                            <div className="relative h-fit w-[332px]  inline-block bg-white rounded-[16px] p-5 shadow-md">
                        ...
                        <div className='flex flex-col gap-5'>
                            <div className='bg-white p-4 h-[459px] w-[527px] rounded-[16px] shadow-md'>
                            ...
                            <div className='bg-white w-[520px]  p-5  rounded-[16px] shadow-md'>
                                <h2 className='text-[20px] font-bold'>SOS</h2>
                                <div className='flex w-[386px] gap-6  mt-3'>
                                    {[...Array(3)].map((_, i) => (
                    ...
                    <div>
                        <div className='flex flex-col gap-5 mt-5'>
                            <div className="bg-white p-5 w-[332px] h-[164px] rounded-[16px] shadow-md">
                        ...
                        <div className='flex flex-col gap-5 mt-4'>
                            <button className='border-[#5B83C2] w-[332px] bg-white border-2 cursor-pointer text-[#5B83C2] font-medium  p-3 rounded-full'>Health History →</button>
                            <button className='border-[#5B83C2] w-[332px] border-2 bg-white cursor-pointer text-[#5B83C2] font-medium  p-3 rounded-full'>Insurance Info →</button>
                        </div>
                    </div>
                </div>
            </div>
